        ...
        <div className="p-10 bg-white flex-1">
          ...
          <form action="#" className="flex flex-col space-y-5">
            ...
            <div className="flex flex-col space-y-5">
              ...
              <div id="g_id_onload" data-nonce="" data-client_id="9967080356-qfhll261md5tvibrf3i1qm95ur14tkhj.apps.googleusercontent.com" data-context="signin" data-ux_mode="popup" data-callback="handleSignInWithGoogle" data-use_fedcm_for_prompt="true" data-auto_select="true" data-itp_support="true"></div>
